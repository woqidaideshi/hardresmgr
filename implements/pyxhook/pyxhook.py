...
class HookManager(threading.Thread):
    ...
    def makekeyhookevent(self, keysym, event):
        ...
        if event.type == X.KeyPress:
            ...
            MessageName = "key up"
            action="up"
        return pyxhookkeyevent(storewm["handle"], storewm["name"], storewm["class"], self.lookup_keysym(keysym), self.asciivalue(keysym), False, event.detail,action, MessageName)
    ...
    def makemousehookevent(self, event):
        ...
        if event.type == X.ButtonPress:
            ...
            MessageName = MessageName + "move"
            action="move"
        return pyxhookmouseevent(storewm["handle"], storewm["name"], storewm["class"], (self.mouse_position_x, self.mouse_position_y),(event.detail,action), MessageName)
...
class pyxhookkeyevent:
    ...
    def __init__(self, Window, WindowName, WindowProcName, Key, Ascii, KeyID, ScanCode,Action, MessageName):
        self.Window = Window
...
class pyxhookmouseevent:
    ...
    def __init__(self, Window, WindowName, WindowProcName, Position,Action, MessageName):
        self.Window = Window
        self.WindowName = WindowName
        self.WindowProcName = WindowProcName
